									...
									<?php
										...
										else
										{
											...
											else
											{
												...
												echo '<img src="../img/admin/tick.png" title="Ends: '.date('d.m.Y H:i',$user['plus']+3600*2).'">';
									...
									<?php
										...
										else
										{
											...
											else
											{
												$tsdiffact = $datetime - $now;
												$timetoecho = $timeformat->getTimeFormat($tsdiffact);
												echo '<img src="../img/admin/tick.png" title="Ends: '.date('d.m.Y H:i',$user['b1']+3600*2).'">';
												echo "<font color=\"blue\"> $timetoecho</font>";
											}
										}
									...
									<?php
										...
										else
										{
											...
											else
											{
												$tsdiffact = $datetime - $now;
												$timetoecho = $timeformat->getTimeFormat($tsdiffact);
												echo '<img src="../img/admin/tick.png" title="Ends: '.date('d.m.Y H:i',$user['b2']+3600*2).'">';
												echo "<font color=\"blue\"> $timetoecho</font>";
											}
										}
									/*
									...
									<?php
										...
										else
										{
											...
											else
											{
												$tsdiffact = $datetime - $now;
												$timetoecho = $timeformat->getTimeFormat($tsdiffact);
												echo '<img src="../img/admin/tick.png" title="Ends: '.date('d.m.Y H:i',$user['b3']+3600*2).'">';
												echo "<font color=\"blue\"> $timetoecho</font>";
											}
										}
									/*
									...
									<?php
										...
										else
										{
											...
											else
											{
												$tsdiffact = $datetime - $now;
												$timetoecho = $timeformat->getTimeFormat($tsdiffact);
												echo '<img src="../img/admin/tick.png" title="Ends: '.date('d.m.Y H:i',$user['b4']+3600*2).'">';
												echo "<font color=\"blue\"> $timetoecho</font>";
											}
										}
									/*
